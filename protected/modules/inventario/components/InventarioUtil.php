 ...
 */
class InventarioUtil extends CComponent
{

    const FLAG_SUCCESS='success';
    const FLAG_NOTICE='notice';
    const FLAG_ERROR='error';
    public static function verificarsignocant($cant)  {
       return ($cant < 0 )?false:true;
        }


    public static function config()
    {
        return Yii::app()->getModule('inventario');
    }

   /* public static function factory()
    {
        return Yii::app()->getModule('inventario')->factory;
    }*/
