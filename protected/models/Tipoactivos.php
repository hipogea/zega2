...
/**
 * This is the model class for table "{{tipoactivos}}".
 *
 * The followings are the available columns in table '{{tipoactivos}}':
 * @property string $codtipo
 * @property string $destipo
 * @property integer $iduser
 */
class Tipoactivos extends CActiveRecord
{
	/**
	 ...
	 * @return Tipoactivos the static model class
	 */
