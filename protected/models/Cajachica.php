...
class Cajachica extends ModeloGeneral
{
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'monto_rendido' => array(self::STAT, 'Dcajachica', 'hidcaja','select'=>'sum(t.debe)','condition'=>" codestado in ('".self::ESTADO_DETALLE_CAJA_CERRADO."','".self::ESTADO_DETALLE_CAJA_CONFIRMADO."') "),
           ...
           //'hijos_cargos'=>array(self::STAT, 'Dcajachica', 'hidcaja','select'=>'count(t.id)','condition'=>" hidcargo >0 and codestado in ('".self::ESTADO_DETALLE_CAJA_PREVIO."','".self::ESTADO_DETALLE_CAJA_CREADO."')  "),
            );
    }
    /**
