...
///APIUNTABDO A LOS ESTADOS
ALTER TABLE public_peticion ADD FOREIGN KEY (codestado) REFERENCES public_estado(codestado);
ALTER TABLE public_tempdpeticion ADD FOREIGN KEY (codestado) REFERENCES public_estado(codestado);
ALTER TABLE public_dpeticion ADD FOREIGN KEY (codestado) REFERENCES public_estado(codestado);

///APIUNTABDO A LOS DOCUMENTOS
ALTER TABLE public_peticion ADD FOREIGN KEY (codocu) REFERENCES public_documentos(coddocu);
ALTER TABLE public_tempdpeticion ADD FOREIGN KEY (codocu) REFERENCES public_documentos(coddocu);
ALTER TABLE public_dpeticion ADD FOREIGN KEY (codocu) REFERENCES public_documentos(coddocu);



///APIUNTABDO A LOS PROVEEDORES
ALTER TABLE public_peticion ADD FOREIGN KEY (codpro) REFERENCES public_clipro(codpro);
ALTER TABLE public_temppeticion ADD FOREIGN KEY (codpro) REFERENCES public_clipro(codpro);
...
///APIUNTABDO A LOS contactos
ALTER TABLE public_peticion ADD FOREIGN KEY (idcontacto) REFERENCES public_contactos(id);
ALTER TABLE public_temppeticion ADD FOREIGN KEY (idcontacto) REFERENCES public_contactos(id);
...
ALTER TABLE public_peticion ADD FOREIGN KEY (um) REFERENCES public_ums(um);
ALTER TABLE public_temppeticion ADD FOREIGN KEY (um) REFERENCES public_ums(um);
...
ALTER TABLE public_dpeticion ADD FOREIGN KEY (codart) REFERENCES public_maestrocomponentes(codigo);
ALTER TABLE public_dtemppeticion ADD FOREIGN KEY (codart) REFERENCES public_maestrocomponentes(codigo);
ALTER TABLE public_dfactur ADD FOREIGN KEY (codart) REFERENCES public_maestrocomponentes(codigo);
ALTER TABLE public_tempdfactur ADD FOREIGN KEY (codart) REFERENCES public_maestrocomponentes(codigo);
...
ALTER TABLE public_dpeticion ADD FOREIGN KEY (codcen) REFERENCES public_centros(codcen);
ALTER TABLE public_dtemppeticion ADD FOREIGN KEY (codcen) REFERENCES public_centros(codcen);
...
ALTER TABLE public_dpeticion ADD FOREIGN KEY (codal) REFERENCES public_almacenes(codalm);
ALTER TABLE public_dtemppeticion ADD FOREIGN KEY (codal) REFERENCES public_almacenes(codalm);
...
///apunadno al kardex
ALTER TABLE public_alkardextraslado ADD FOREIGN KEY (hidkardexemi) REFERENCES public_alkardex(id);
ALTER TABLE public_alkardextraslado ADD FOREIGN KEY (hidkardexdes) REFERENCES public_alkardex(id);


///APUNTADNO A ALMACENMOVIMIENTOS
ALTER TABLE public_almacendocs ADD FOREIGN KEY (codmovimiento) REFERENCES public_almacenmovimientos(codmov);
///APUNTADNO A ALMACENMOVIMIENTOS
ALTER TABLE public_detgui ADD FOREIGN KEY (n_hguia) REFERENCES public_guia(id);

///APUNTADNO A lla factura
ALTER TABLE public_dfactur ADD FOREIGN KEY (hidfactu) REFERENCES public_factur(id);
ALTER TABLE public_tempdfactur ADD FOREIGN KEY (hidfactu) REFERENCES public_factur(id);