...
class TipoactivosController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Tipoactivos');
	...
	{
		$model=new Tipoactivos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tipoactivos']))
			$model->attributes=$_GET['Tipoactivos'];
	 ...
	 * @param Tipoactivos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipoactivos-form')
		{
