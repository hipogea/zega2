...
class UsuariosfavoritosController extends Controller
{
	/**
...
public function actionmisbloqueos(){
 $this->render('misbloqueos');
	...
	public function actionborrabloqueo(){
         // if (isset($_GET['ajax'])){
			  ...
			  if(!is_null($registrobloqueo))
			  {
				  ...
				  { echo "Se desbloqueo el documento";}else{
					  echo "Hubo un error ";
				  }
	...
	{
		$dataProvider=new CActiveDataProvider('Usuariosfavoritos');
	...
	{
		var_dump(yii::app()->settings->get('materiales_codigoservicio'));yii::app()->end();
		$model=new Usuariosfavoritos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Usuariosfavoritos']))
			$model->attributes=$_GET['Usuariosfavoritos'];
	 ...
	 * @param Usuariosfavoritos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='usuariosfavoritos-form')
		{
