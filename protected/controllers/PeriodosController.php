...
class PeriodosController extends Controller
{
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Periodos']))
			$model->attributes=$_GET['Periodos'];
	...
	{
		$model=Periodos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Periodos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='periodos-form')
		{
